...
(function() {
  ...
  this.AudioPlayerUI = (function() {
    AudioPlayerUI.prototype.transitionEvents = ["transitioned", "webkitTransitionEnd", "MSTransitionEnd", "oTransitionEnd"];
...
//      this.$button = this.$el.find(".audio-player-place-pause-button");
	  this.$button = this.$el.find(".audio-player-place-pause-button .fa");
